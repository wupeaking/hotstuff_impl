...
func (ts *TCPStream) packageData(msg *p2p.BroadcastMsg) ([]byte, error) {
...
func (ts *TCPStream) unpackageData(rw *bufio.Reader) (*p2p.BroadcastMsg, error) {
	// 尝试读取magic 头
